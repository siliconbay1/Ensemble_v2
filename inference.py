...
def main(args):
    ...
    sr_model = build_model(f"MIMOUNetPlus", device)
    print(f"Build `{args.model_arch_name}` model successfully.")

    # Load model weights
    sr_model = load_pretrained_state_dict(sr_model, False, args.model_weights_path)
    ...
    # Save image
    cr_image = tensor_to_image(sr_tensor[2], False, args.half)
